...
const MANAGER_PHOTOS: Record<string, string> = {
  ...
  "Mr. Sibar Andualem": "/images/manager%20images/sibar%20andualem.png",
...
const buildingAOffices: Office[] = [
  {
    ...
    workAmharic:
      "የሥራ አስፈጻሚ አመራር ይሰጣል፣ ስትራቴጂካዊ አቅጣጫ ያስቀምጣል እና የሚኒስቴሩን አጠቃላይ ቅንጅት ይቆጣጠራል።",
    manager: {
  ...
  },
  {
    ...
    workAmharic:
      "በሚኒስቴሩ ውስጥ በፖሊሲ፣ ኮሙዩኒኬሽን፣ ሕግ፣ ኦዲት፣ ሥነ-ምግባር፣ ተቋማዊ ለውጥ እና ማህበራዊ አካታችነት ላይ አማካሪ ድጋፍ ይሰጣል።",
    manager: {
    ...
    departments: [
      ...
      dept(
        ...
        "Policy & Strategy Research Office",
        "የፖሊሲና ስትራቴጂ ምርምር ቢሮ",
        "Building A",
        "8",
        "804",
        "A-804",
        "Dr. Bekuratsion Alemayehu",
        "ዶ/ር በኩረጽዮን አለማየሁ",
        "Policy and Strategy Research Lead Executive",
        "የፖሊሲና ስትራቴጂ ምርምር መሪ ስራ አስፈጻሚ",
        "8004",
      ...
      dept(
        ...
        "Mr. Tesfaye Alemnew",
        "አቶ ተስፋዬ አለምነው",
        "Public Relations and Communication Service Executive",
        "የሕዝብ ግንኙነትና ኮሙኒኬሽን አገልግሎት ስራ አስፈጻሚ",
        "8005",
      ...
      dept(
        "women-youth-social",
        "Women and Youth Social Inclusion Office",
        "የሴቶችና ወጣቶች ማህበራዊ አካታችነት ቢሮ",
        "Building A",
        "8",
        "807",
        "A-807",
        "Mrs. Elsabet Gebreselasie",
        "ወ/ሮ ኤልሳቤጥ ገብረስላሴ",
        "Women and Youth Social Inclusion Implementation Executive",
        "የሴቶችና ወጣቶች ማህበራዊ አካታችነት ስራ አስፈጻሚ",
        "8007",
      ...
      dept(
        ...
        "Mrs. Adanech Tujo",
        "ወ/ሮ አዳነች ቱጆ",
        "Head of Innovation Fund Office",
        "የኢኖቬሽን ፈንድ ጽ/ቤት ኃላፊ",
        "8008",
  ...
  },
  {
    ...
    name: "Head of Minister's Office",
    amharic: "የሚኒስትር ጽ/ቤት ኃላፊ",
    icon: "handshake",
    work: "Builds strategic partnerships and alliances with local and international technology and innovation stakeholders.",
    workAmharic:
      "ከአካባቢያዊ እና ዓለም አቀፍ የቴክኖሎጂ እና ኢኖቬሽን ባለድርሻዎች ጋር ስትራቴጂካዊ አጋርነቶችን እና ትስስሮችን ይገነባል።",
    manager: {
      name: "Mr. Leul Seyoum",
      nameAmharic: "አቶ ልዑል ስዩም",
      position: "Head of Minister's Office",
      positionAmharic: "የሚኒስትር ጽ/ቤት ኃላፊ",
  ...
  },
  {
    ...
    departments: [
      ...
      dept(
        "national-research",
        "National Research & Development Office",
        "የብሔራዊ ምርምርና ልማት ቢሮ",
        "Building A",
        "5",
        "501",
        ...
        "Dr. Habtamu Abera",
        "ዶ/ር ሃብታሙ አበራ",
        "CEO of National Research & Development",
        "የብሔራዊ ምርምር እና ልማት ዋና ስራ አስፈጻሚ",
        "3003",
      ...
      dept(
        ...
        "Technology Development & Transfer Office",
        "የቴክኖሎጂ ልማትና ሽግግር ቢሮ",
        "Building A",
        "5",
        "502",
        "A-502",
        "Dr. Teklemariam Tesema",
        "ዶ/ር ተክለማርያም ተሰማ",
        "CEO of Technology Development & Transfer",
        "የቴክኖሎጂ ልማት እና ሽግግር ዋና ስራ አስፈጻሚ",
        "3004",
  ...
  {
    id: "administration",
    name: "Chief Administration",
    amharic: " የስራ አመራር ዋና ስራ አስፈጻሚ ",
    icon: "building",
    work: "Manages the Ministry's finance, procurement, human resources, facilities and internal ICT services.",
    workAmharic:
      "የሚኒስቴሩን ፋይናንስ፣ ግዢ፣ ሰው ሀብት፣ ተቋማት እና ውስጣዊ አይሲቲ አገልግሎቶች ያስተዳድራል።",
    manager: {
    ...
    departments: [
      dept(
        "finance-procurement",
        "Procurement & Finance Office",
        "የግዢና ፋይናንስ ቢሮ",
        "Building A",
        "3",
        "306",
        "A-306",
        "Mrs. Etalemahu Gezahagn",
        "ወ/ሮ እታለማሁ ገዛኸኝ",
      ...
      dept(
        ...
        "የኢንፎርሜሽን ኮሙኒኬሽን ቴክኖሎጂ ስራ አስፈጻሚ",
        "5003",
      ...
      dept(
        ...
        "Mr. Azmach Desalegn",
        "አቶ አዝማች ደሳለኝ",
        "Executive of Strategic Affairs",
        "የስትራቴጂክ ጉዳዮች ስራ አስፈጻሚ",
        "5002",
      ...
      dept(
        "basic-services",
        "Basic Infrastructure & General Services Office",
        "የመሠረተ ልማትና አጠቃላይ አገልግሎት ቢሮ",
        "Building A",
        "3",
        "304",
        "A-304",
        "Mr. Yidnekachew Teshome",
        "አቶ ይደነቃቸው ተሾመ",
        "Basic Infrastructure & General Services Executive",
      ...
      dept(
        "human-resource",
        "Competency & Human Resource Management Office",
        "የብቃትና ሰው ሀብት አስተዳደር ቢሮ",
        "Building A",
        "3",
        "305",
        "A-305",
        "Mr. Adagne Assefa",
        "አቶ አዳኘ አሰፋ",
        "Competency & Human Resource Management Executive",
